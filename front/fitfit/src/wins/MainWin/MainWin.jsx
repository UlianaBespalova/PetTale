...
const MainWin = ({updateParams, clothesType, itemList, sizes, itemImg}) => {
                            ...
                            <div className="row mx-0 accordion" id="tabs">
                                <div className="col-lg-5 mt-0">
                                    ...
                                    <div className="mt-3" id="leftList">
                                        ...
                                        <div className="photo"><Tab title="Что-то с фото" label="photo" /></div>
                                ...
                                <div className="col-lg-7 pt-4 p-lg-0">
                                    <div className="col-lg-8" id="rightList">
                                        ...
                                        <div className="photo" hidden={true}><Tab title="Что-то с фото" label="photo"/></div>
                                        <div className="recommendations" hidden={true}><Tab title="Рекомендации" label="recommendations"/></div>
                                    </div>
                                    <SizeTab updateParams={updateParams} clothesType={clothesType} sizes={sizes}/>
                                    <PhotoTab />
                                    <RecommendsTab itemList={itemList}/>
                                </div>
                            </div>
                        </div>
                    </div>
